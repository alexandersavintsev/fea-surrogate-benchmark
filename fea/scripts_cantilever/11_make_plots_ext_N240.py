...
DATA = os.path.join(ROOT, "data", "ext_h020_N240")
FIG = os.path.join(ROOT, "figures", "ext_h020_N240")
MODELS = os.path.join(ROOT, "models", "ext_h020_N240")
...
def fig_pairplot():
    p = os.path.join(DATA, "cantilever_doe_inputs_ext_h020_N240.csv")
    ...
    fig.suptitle("Распределение DOE-точек по парам параметров (расширенный диапазон, 240 точек)")
