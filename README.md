...
Код распространяется по лицензии **MIT** - см. файл [LICENSE](LICENSE). Коротко: разрешено свободно использовать, копировать, изменять и распространять проект, в том числе в коммерческих целях, при условии сохранения текста лицензии и указания авторства. Автор не даёт гарантий и не несёт ответственности за последствия использования.

Расчётные данные в `data/` получены автором самостоятельно в ANSYS Mechanical APDL и распространяются на тех же условиях. При использовании результатов в научных или учебных работах - ссылка на репозиторий приветствуется.
